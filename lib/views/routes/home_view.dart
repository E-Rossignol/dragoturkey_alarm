...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // <-- rendre le scaffold transparent pour laisser le fond parent visible
      extendBodyBehindAppBar: true,
      // <-- permet au body d'être rendu derrière l'appbar (visible sous la bar)
      body: Container(
        ...
        child: Center(
          child: Padding(
            ...
            child: Column(
              ...
              // la colonne prendra seulement la hauteur nécessaire
              children: [
                GridView.count(
                  shrinkWrap: true,
                  // la grille s'ajuste à son contenu
                  ...
                  children: [
                    SvgOptionCard(
                      ...
                      backgroundImage: 'assets/images/background_purple.jpeg',
                      // <-- image JPEG en fond pour la première carte
                      iconsPerRow: 1,
                      onTap: () => Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const CaresseurView(),
                        ),
                      ),
                      colors: [],
                    ),
                    SvgOptionCard(
                      ...
                      backgroundImage: 'assets/images/background_orange.jpeg',
                      // <-- image JPEG en fond pour la deuxième carte
                      colors: [],
                      iconsPerRow: 1,
                      onTap: () => Navigator.of(context).push(
                    ...
                    SvgOptionCard(
                      ...
                      onTap: () => Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const DragofesseView(),
                        ),
                      ),
                    ),
                    SvgOptionCard(
                      ...
                      onTap: () => Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const FoudroyeurView(),
                        ),
                      ),
                    ),
                    SvgOptionCard(
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final double cellWidth =
            (totalWidth - (crossCount - 1) * crossAxisSpacing) / crossCount;
        final double cellHeight =
            (totalHeight - (rows - 1) * mainAxisSpacing) / rows;
